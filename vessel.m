...
A_membrane_vessel = A_m*N_elements; % Total active area of the membrane in the vessel [m2]
A_total = A_membrane_vessel*N_vessels; % Total active area of the membrane in the system [m2]